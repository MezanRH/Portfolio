...
import darz from '../assets/daraz.png'
import tronix from '../assets/tronix.png'
  ...
  return (
    <Container className="bg-2nd pt-16 md:pt-32 px-3 font-inter">
      ...
      <div className='border border-slate-300 bg-black rounded p-2 md:p-5 mr-0 md:mr-2 mt-1 md:mt-5'>
            <img src={tronix} className=' rounded'/>
            <Button text="Html" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 text-sm"/>
            <Button text="tailwindcss" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            <Button text="React" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            <Button text="Redux" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            <Button text="React-router" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            ...
            <a href="https://tronix-five.vercel.app/">
            <Button text="Live Demo" className=" px-4 md:px-8 mt-4"/>
            </a>
            <a href="https://github.com/MezanRH/tronix">
      ...
      <div className='border border-slate-300 bg-black rounded p-2 md:p-5 mr-0 md:mr-2 mt-1 md:mt-5'>
            <img src={darz} className=' rounded'/>
            <Button text="Html" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 text-sm"/>
            <Button text="tailwindcss" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            <Button text="Boostrap" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            <Button text="React" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            <Button text="React-redux" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            <Button text="React-router" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            <p className=' text-white font-normal text-xl mt-4'>Creative designer</p>
            <h5 className='text-white font-normal text-xs mt-2'>January 2024 - February 2024</h5>
            <p className=' text-white text-sm mt-3'>It's a agency website . In this website company explain their service and thair company employe.</p>
            ...
            <div className=' flex justify-between'>
            <a href="https://daraz-beta.vercel.app/">
            <Button text="Live Demo" className=" px-4 md:px-8 mt-4"/>
            </a>
            <a href="https://github.com/MezanRH/daraz">
            <Button text="Github Repo" className=" px-4 md:px-8 mt-4"/>
            </a>
            </div>
      </div>
      <div className='border border-slate-300 bg-black rounded p-2 md:p-5 mr-0 md:mr-2 mt-1 md:mt-5'>
            <img src={cid} className=' rounded'/>
            <Button text="Html" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 text-sm"/>
            <Button text="tailwindcss" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            <Button text="Boostrap" className=" px-0 md:px-2 py-0 text-white mt-2 md:mt-4 ml-2 text-sm"/>
            <p className=' text-white font-normal text-xl mt-4'>Creative designer</p>
            ...
            <div className=' flex justify-between'>
            <a href="https://cid-website.vercel.app/">
            <Button text="Live Demo" className=" px-4 md:px-8 mt-4"/>
            </a>
            <a href="https://github.com/MezanRH/cid_website">
            <Button text="Github Repo" className=" px-4 md:px-8 mt-4"/>
            </a>
            </div>
      </div>
